...
# ShieldDisruptor
[![License: MIT](https://img.shields.io/badge/license-AGPL-brightgreen)](https://www.gnu.org/licenses/agpl-3.0.en.html)
![](https://img.shields.io/badge/environment-client-blue)
...
![Version](https://img.shields.io/github/v/tag/MightyKnight/ShieldDisruptor?label=version)
...
- You need [Fabric API](https://modrinth.com/mod/fabric-api) or for Quilt its equivalent [Quilted Fabric API](https://modrinth.com/mod/qsl).
